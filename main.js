    ...
    function gotResult(error, results)
     { 
         if (error) {
              ...
              document.getElementById('label').innerHTML = "Object: " + drawn_sketch;
